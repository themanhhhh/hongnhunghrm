...
const foreignKeys = [
    ...
    ['LeaveApplication', 'approver_id', 'Employee', 'employee_id', 'SET NULL'], ['LeaveApplication', 'related_person_id', 'Employee', 'employee_id', 'NO ACTION'],
    ...
    ['ContractExtension', 'employee_id', 'Employee', 'employee_id', 'NO ACTION'], ['TransferProposal', 'employee_id', 'Employee', 'employee_id', 'CASCADE'],
